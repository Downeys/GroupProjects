...
import com.example.motoinventoryservice.feign.VinLookupClient;
...
public class MotoInventoryController {
    ...
    private VinLookupClient client;
    ...
    public Map<String, String> findVehicleByVin(@PathVariable String vin){
        Map<String, String> returnVal = new HashMap<>();
        returnVal = client.findVehicleByVin(vin);
        return returnVal;
    }
}
